        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <form method="POST" action="{{ route('pots.store') }}" enctype="multipart/form-data" id="quickForm">
                        @CSRF
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Pot Pages</label>
                                            <select class="form-control" name="page_id" style="width: 100%;">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <input type="submit" value="Publish pot" class="btn btn-success float-right">
                            </div>
                        </div>
                    </form>
                </section>
