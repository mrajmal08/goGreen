        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="{{ route('seeds.index') }}">All
                                        Seeds</a></li>
                                    <li class="breadcrumb-item active">Seeds Post</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                ...
                <section class="content">
                    ...
                    <form method="POST" action="{{ route('seeds.store') }}" enctype="multipart/form-data" id="quickForm">
                        @CSRF
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                ...
                                <input type="submit" value="Publish seed" class="btn btn-success float-right">
                            </div>
                        </div>
                    </form>
                </section>
