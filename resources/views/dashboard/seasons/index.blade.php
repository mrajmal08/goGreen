                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">Plansts By Season</li>
                                </ol>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a href="{{ route('season.create') }}" class="btn btn-success">Add New Plant </a>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach ($seasons as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="">
                                                                <a href="{{ asset('assets/seasonsFiles') . '/' . $item->photo }}?text=1"
                                                                    data-toggle="lightbox"
                                                                    data-title="{{ $item->name }}"
                                                                    data-gallery="gallery">
                                                                    <img src="{{ asset('assets/seasonsFiles') . '/' . $item->photo }}?text=1"
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ route('season.delete', [$item->id]) }}"
